          ...
          <g key={constellation.name}>
              ...
              {constellation.lines.map((line, i) => {
                ...
                return (
                  <line
                    ...
                    strokeWidth="1.2" strokeOpacity="0.12"
                    filter="url(#line-glow)" vectorEffect="non-scaling-stroke"
                  />
                );
              })}
            </g>
              ...
              {constellation.lines.map((line, i) => {
                ...
                return (
                  <line
                    ...
                    strokeWidth="0.15" strokeOpacity="0.4"
            ...
            {constellation.stars.map((star, i) => (
              <use
                ...
                x={star.x} y={star.y} opacity={star.brightness}
              />
            ))}
          </g>
        ))}
