...
export interface HexagramData {
  ...
  binary: string; // length-6, bottom→top, '1'=solid/yang, '0'=broken/yin
}
...
export const HEXAGRAMS: HexagramData[] = [
  { number: 1,  name: 'The Creative',               symbol: '䷀', judgment: 'The creative principle brings success through perseverance. Sublime and initiative.',
    themes: ['authority', 'illumination', 'harmony'], dimensions: { favorability: 2.0, certainty: 1.5, volatility: 0.0 }, modifierRoles: ['action', 'subject'], binary: '111111' },
  { number: 2,  name: 'The Receptive',              symbol: '䷁', judgment: 'The receptive brings supreme success through devotion to what is right.',
    themes: ['surrender', 'harmony'], dimensions: { favorability: 1.5, certainty: 0.5, volatility: -0.5 }, modifierRoles: ['subject', 'effect'], binary: '000000' },
  { number: 3,  name: 'Difficulty at the Beginning', symbol: '䷂', judgment: 'Initial challenges bring growth. Perseverance furthers.',
    themes: ['stagnation', 'conflict'], dimensions: { favorability: -1.0, certainty: 0.5, volatility: 1.0 }, modifierRoles: ['action'], binary: '100010' },
  { number: 4,  name: 'Youthful Folly',              symbol: '䷃', judgment: 'The inexperienced must seek guidance. It is not the teacher who seeks the student.',
    themes: ['mystery', 'stagnation'], dimensions: { favorability: -0.5, certainty: -1.0, volatility: 1.0 }, modifierRoles: ['subject'], binary: '010001' },
  { number: 5,  name: 'Waiting',                     symbol: '䷄', judgment: 'Patience and sincere waiting bring success. The timing is not yet ripe.',
    themes: ['stagnation', 'surrender'], dimensions: { favorability: 0.0, certainty: -1.5, volatility: 1.0 }, modifierRoles: ['subject', 'action'], binary: '111010' },
  { number: 6,  name: 'Conflict',                    symbol: '䷅', judgment: 'Conflict arises when truth is contested. Seek impartial resolution.',
    themes: ['conflict', 'authority'], dimensions: { favorability: -1.0, certainty: 0.5, volatility: 1.5 }, modifierRoles: ['action', 'effect'], binary: '010111' },
  { number: 7,  name: 'The Army',                    symbol: '䷆', judgment: 'Disciplined collective action brings success. Leadership is required.',
    themes: ['authority', 'conflict'], dimensions: { favorability: 0.0, certainty: 1.0, volatility: 0.5 }, modifierRoles: ['action'], binary: '010000' },
  { number: 8,  name: 'Holding Together',            symbol: '䷇', judgment: 'Union and cohesion bring strength. Those uncertain will find their way.',
    themes: ['harmony', 'authority'], dimensions: { favorability: 1.0, certainty: 0.5, volatility: -0.5 }, modifierRoles: ['subject', 'action'], binary: '000010' },
  { number: 9,  name: 'Small Taming',                symbol: '䷈', judgment: 'Gentle restraint yields progress. Small forces shape great outcomes.',
    themes: ['authority', 'stagnation'], dimensions: { favorability: 0.5, certainty: 0.0, volatility: -0.5 }, modifierRoles: ['action'], binary: '111011' },
  { number: 10, name: 'Treading',                    symbol: '䷉', judgment: 'Conduct yourself with care. Even dangerous paths can be walked safely.',
    themes: ['conflict', 'mystery'], dimensions: { favorability: -0.5, certainty: -0.5, volatility: 1.0 }, modifierRoles: ['subject', 'action'], binary: '110111' },
  { number: 11, name: 'Peace',                       symbol: '䷊', judgment: 'Harmony between heaven and earth. The small departs, the great approaches.',
    themes: ['harmony', 'renewal'], dimensions: { favorability: 2.0, certainty: 1.0, volatility: -1.0 }, modifierRoles: ['subject', 'effect'], binary: '111000' },
  { number: 12, name: 'Standstill',                  symbol: '䷋', judgment: 'Stagnation and blockage. The great departs, the small approaches. Endure.',
    themes: ['stagnation', 'conflict'], dimensions: { favorability: -1.5, certainty: 0.5, volatility: -0.5 }, modifierRoles: ['action', 'effect'], binary: '000111' },
  { number: 13, name: 'Fellowship',                  symbol: '䷌', judgment: 'Community and shared purpose bring clarity. Openness unites.',
    themes: ['harmony', 'illumination'], dimensions: { favorability: 1.0, certainty: 1.0, volatility: -0.5 }, modifierRoles: ['subject', 'action'], binary: '101111' },
  { number: 14, name: 'Great Possession',            symbol: '䷍', judgment: 'Abundance in harmony. Generosity ensures continued prosperity.',
    themes: ['authority', 'harmony'], dimensions: { favorability: 1.5, certainty: 1.5, volatility: -1.0 }, modifierRoles: ['subject', 'effect'], binary: '111101' },
  { number: 15, name: 'Modesty',                     symbol: '䷎', judgment: 'Humility elevates. The modest are carried forward by the flow of things.',
    themes: ['harmony', 'surrender'], dimensions: { favorability: 1.0, certainty: 0.5, volatility: -1.0 }, modifierRoles: ['subject'], binary: '001000' },
  { number: 16, name: 'Enthusiasm',                  symbol: '䷏', judgment: 'Enthusiastic movement inspires others. But enthusiasm must be grounded.',
    themes: ['renewal', 'harmony'], dimensions: { favorability: 1.0, certainty: -0.5, volatility: 1.0 }, modifierRoles: ['action', 'subject'], binary: '000100' },
  { number: 17, name: 'Following',                   symbol: '䷐', judgment: 'Adapting to the flow of events brings success. The wise yield when necessary.',
    themes: ['surrender', 'transformation'], dimensions: { favorability: 0.5, certainty: -1.0, volatility: 1.0 }, modifierRoles: ['action', 'subject'], binary: '100110' },
  { number: 18, name: 'Work on the Decayed',         symbol: '䷑', judgment: 'Corruption can be corrected through determined effort. Renewal follows decay.',
    themes: ['transformation', 'renewal', 'stagnation'], dimensions: { favorability: 0.0, certainty: 0.5, volatility: 1.0 }, modifierRoles: ['action', 'effect'], binary: '011001' },
  { number: 19, name: 'Approach',                    symbol: '䷒', judgment: 'Advancement is at hand. Favor comes to those who act with generosity.',
    themes: ['renewal', 'harmony'], dimensions: { favorability: 1.5, certainty: 1.0, volatility: -0.5 }, modifierRoles: ['subject', 'effect'], binary: '110000' },
  { number: 20, name: 'Contemplation',               symbol: '䷓', judgment: 'Observation reveals the deeper patterns. Understanding comes through reflection.',
    themes: ['illumination', 'mystery'], dimensions: { favorability: 0.5, certainty: -1.5, volatility: 0.0 }, modifierRoles: ['subject'], binary: '000011' },
  { number: 21, name: 'Biting Through',              symbol: '䷔', judgment: 'Obstacles must be overcome with decisive action. Obstruction yields to force.',
    themes: ['conflict', 'authority'], dimensions: { favorability: 0.0, certainty: 1.5, volatility: 0.0 }, modifierRoles: ['action', 'effect'], binary: '100101' },
  { number: 22, name: 'Grace',                       symbol: '䷕', judgment: 'Beauty and refinement enhance the natural. But substance matters more than ornament.',
    themes: ['harmony', 'illumination'], dimensions: { favorability: 0.5, certainty: 0.0, volatility: -0.5 }, modifierRoles: ['subject', 'effect'], binary: '101001' },
  { number: 23, name: 'Splitting Apart',             symbol: '䷖', judgment: 'Decay spreads from within. The inferior threaten the superior. Wait.',
    themes: ['upheaval', 'stagnation'], dimensions: { favorability: -1.5, certainty: 1.0, volatility: 1.0 }, modifierRoles: ['action', 'effect'], binary: '000001' },
  { number: 24, name: 'Return',                      symbol: '䷗', judgment: 'The turning point has come. Renewal begins after the darkness recedes.',
    themes: ['renewal', 'transformation'], dimensions: { favorability: 1.0, certainty: 0.5, volatility: 0.5 }, modifierRoles: ['subject', 'effect'], binary: '100000' },
  { number: 25, name: 'Innocence',                   symbol: '䷘', judgment: 'Act with natural sincerity. Unplanned virtue brings unexpected rewards.',
    themes: ['harmony', 'illumination'], dimensions: { favorability: 1.5, certainty: 0.0, volatility: -1.0 }, modifierRoles: ['subject', 'action'], binary: '100111' },
  { number: 26, name: 'Great Taming',                symbol: '䷙', judgment: 'Great power is enriched through discipline and restraint. Accumulation furthers.',
    themes: ['authority', 'stagnation'], dimensions: { favorability: 1.0, certainty: 1.0, volatility: -1.5 }, modifierRoles: ['action'], binary: '111001' },
  { number: 27, name: 'Nourishment',                 symbol: '䷚', judgment: 'Sustain yourself and others. Words and actions must be measured and deliberate.',
    themes: ['harmony', 'renewal'], dimensions: { favorability: 1.0, certainty: 0.5, volatility: -0.5 }, modifierRoles: ['subject', 'action', 'effect'], binary: '100001' },
  { number: 28, name: 'Great Preponderance',         symbol: '䷛', judgment: 'Excess strains all systems. Extraordinary times call for extraordinary measures.',
    themes: ['upheaval', 'conflict'], dimensions: { favorability: -1.0, certainty: 0.5, volatility: 2.0 }, modifierRoles: ['action', 'effect'], binary: '011110' },
  { number: 29, name: 'The Abysmal',                 symbol: '䷜', judgment: 'Danger repeated requires caution. Sincerity and adaptability carry one through.',
    themes: ['mystery', 'conflict'], dimensions: { favorability: -1.5, certainty: -1.0, volatility: 1.5 }, modifierRoles: ['subject', 'action'], binary: '010010' },
  { number: 30, name: 'The Clinging',                symbol: '䷝', judgment: 'Dependence on what is luminous brings clarity. Attachment must be balanced.',
    themes: ['illumination', 'harmony'], dimensions: { favorability: 0.5, certainty: -0.5, volatility: 0.0 }, modifierRoles: ['subject', 'effect'], binary: '101101' },
  { number: 31, name: 'Influence',                   symbol: '䷞', judgment: 'Mutual attraction creates connection. True influence is gentle and persistent.',
    themes: ['harmony', 'transformation'], dimensions: { favorability: 1.0, certainty: 0.0, volatility: 0.5 }, modifierRoles: ['subject', 'action'], binary: '001110' },
  { number: 32, name: 'Duration',                    symbol: '䷟', judgment: 'Endurance and constancy bring success. Change within stability is the way.',
    themes: ['harmony', 'stagnation'], dimensions: { favorability: 0.5, certainty: 1.5, volatility: -1.5 }, modifierRoles: ['subject', 'effect'], binary: '011100' },
  { number: 33, name: 'Retreat',                     symbol: '䷠', judgment: 'Withdrawal is strategic, not weak. Timely retreat preserves strength.',
    themes: ['surrender', 'stagnation'], dimensions: { favorability: -0.5, certainty: 0.5, volatility: -0.5 }, modifierRoles: ['action'], binary: '001111' },
  { number: 34, name: 'Great Power',                 symbol: '䷡', judgment: 'Strength must be guided by justice. Power without direction leads to excess.',
    themes: ['authority', 'conflict'], dimensions: { favorability: 1.0, certainty: 1.0, volatility: 1.0 }, modifierRoles: ['action', 'subject'], binary: '111100' },
  { number: 35, name: 'Progress',                    symbol: '䷢', judgment: 'Advancement comes to those who are bright and generous. Success through merit.',
    themes: ['renewal', 'harmony'], dimensions: { favorability: 1.5, certainty: 1.0, volatility: -0.5 }, modifierRoles: ['subject', 'effect'], binary: '000101' },
  { number: 36, name: 'Darkening of the Light',      symbol: '䷣', judgment: 'The light fades but is not extinguished. Endure hardship with inner clarity.',
    themes: ['mystery', 'stagnation', 'conflict'], dimensions: { favorability: -1.5, certainty: 0.5, volatility: 1.0 }, modifierRoles: ['subject', 'action'], binary: '101000' },
  { number: 37, name: 'The Family',                  symbol: '䷤', judgment: 'Proper order in the home extends to all affairs. Roles bring harmony.',
    themes: ['harmony', 'authority'], dimensions: { favorability: 1.0, certainty: 1.0, volatility: -1.0 }, modifierRoles: ['subject', 'action'], binary: '101011' },
  { number: 38, name: 'Opposition',                  symbol: '䷥', judgment: 'Divergence creates tension but also perspective. Small matters may still succeed.',
    themes: ['conflict', 'transformation'], dimensions: { favorability: -0.5, certainty: -1.0, volatility: 1.5 }, modifierRoles: ['action', 'effect'], binary: '110101' },
  { number: 39, name: 'Obstruction',                 symbol: '䷦', judgment: 'Obstacles block the path. Turn inward and seek wisdom before proceeding.',
    themes: ['stagnation', 'conflict'], dimensions: { favorability: -1.0, certainty: 0.5, volatility: -0.5 }, modifierRoles: ['subject', 'action'], binary: '001010' },
  { number: 40, name: 'Deliverance',                 symbol: '䷧', judgment: 'Release from difficulty arrives. Act quickly when the moment opens.',
    themes: ['renewal', 'transformation'], dimensions: { favorability: 1.5, certainty: 0.5, volatility: 1.5 }, modifierRoles: ['action', 'effect'], binary: '010100' },
  { number: 41, name: 'Decrease',                    symbol: '䷨', judgment: 'Loss brings hidden gain. Sacrifice now yields reward later.',
    themes: ['stagnation', 'surrender'], dimensions: { favorability: -0.5, certainty: 0.0, volatility: 0.5 }, modifierRoles: ['subject', 'effect'], binary: '110001' },
  { number: 42, name: 'Increase',                    symbol: '䷩', judgment: 'Growth comes through selfless contribution. The more given, the more received.',
    themes: ['renewal', 'harmony'], dimensions: { favorability: 1.5, certainty: 1.0, volatility: 0.0 }, modifierRoles: ['subject', 'effect'], binary: '100011' },
  { number: 43, name: 'Breakthrough',                symbol: '䷪', judgment: 'Resolution must be decisive. Truth proclaimed brings change.',
    themes: ['illumination', 'upheaval'], dimensions: { favorability: 1.0, certainty: 1.5, volatility: 1.5 }, modifierRoles: ['action'], binary: '111110' },
  { number: 44, name: 'Coming to Meet',              symbol: '䷫', judgment: 'Unexpected encounters bring new possibilities. Caution tempers opportunity.',
    themes: ['mystery', 'transformation'], dimensions: { favorability: 0.0, certainty: -1.0, volatility: 1.5 }, modifierRoles: ['subject', 'action'], binary: '011111' },
  { number: 45, name: 'Gathering Together',          symbol: '䷬', judgment: 'Collective unity brings strength. The many are greater than the few.',
    themes: ['harmony', 'authority'], dimensions: { favorability: 1.0, certainty: 1.0, volatility: -0.5 }, modifierRoles: ['subject', 'action'], binary: '000110' },
  { number: 46, name: 'Pushing Upward',              symbol: '䷭', judgment: 'Steady advancement through merit. The worthy rise naturally.',
    themes: ['renewal', 'authority'], dimensions: { favorability: 1.0, certainty: 1.0, volatility: 0.0 }, modifierRoles: ['action'], binary: '011000' },
  { number: 47, name: 'Oppression',                  symbol: '䷮', judgment: 'Exhaustion and limitation test the spirit. Perseverance in adversity refines character.',
    themes: ['stagnation', 'conflict'], dimensions: { favorability: -1.5, certainty: 0.5, volatility: 0.5 }, modifierRoles: ['subject', 'action'], binary: '010110' },
  { number: 48, name: 'The Well',                    symbol: '䷯', judgment: 'Nourishment is available to all who draw from the source. Community depends on shared resources.',
    themes: ['harmony', 'illumination'], dimensions: { favorability: 0.5, certainty: -0.5, volatility: -1.0 }, modifierRoles: ['subject', 'effect'], binary: '011010' },
  { number: 49, name: 'Revolution',                  symbol: '䷰', judgment: 'Fundamental change is necessary. Shed the old to make way for the new.',
    themes: ['upheaval', 'transformation'], dimensions: { favorability: 0.0, certainty: 1.5, volatility: 2.0 }, modifierRoles: ['action', 'effect'], binary: '101110' },
  { number: 50, name: 'The Cauldron',                symbol: '䷱', judgment: 'Transformation through refinement. The raw is made useful through careful tending.',
    themes: ['transformation', 'authority'], dimensions: { favorability: 1.0, certainty: 1.0, volatility: 0.0 }, modifierRoles: ['action', 'effect'], binary: '011101' },
  { number: 51, name: 'The Arousing',                symbol: '䷲', judgment: 'Shock awakens and brings terror, then laughter. Disruption precedes new order.',
    themes: ['upheaval', 'illumination'], dimensions: { favorability: -0.5, certainty: 1.0, volatility: 2.0 }, modifierRoles: ['action', 'effect'], binary: '100100' },
  { number: 52, name: 'Keeping Still',               symbol: '䷳', judgment: 'Stillness in the face of distraction brings clarity. Know when to act and when to rest.',
    themes: ['stagnation', 'harmony'], dimensions: { favorability: 0.0, certainty: 0.5, volatility: -2.0 }, modifierRoles: ['subject', 'action'], binary: '001001' },
  { number: 53, name: 'Development',                 symbol: '䷴', judgment: 'Gradual progress is the surest path. The journey unfolds one step at a time.',
    themes: ['transformation', 'harmony'], dimensions: { favorability: 1.0, certainty: 0.5, volatility: -1.0 }, modifierRoles: ['subject', 'effect'], binary: '001011' },
  { number: 54, name: 'The Marrying Maiden',         symbol: '䷵', judgment: 'Alliances create new patterns. Overreaching brings regret.',
    themes: ['harmony', 'mystery'], dimensions: { favorability: 0.0, certainty: -1.0, volatility: 1.0 }, modifierRoles: ['subject', 'effect'], binary: '110100' },
  { number: 55, name: 'Abundance',                   symbol: '䷶', judgment: 'Peak prosperity arrives. Greatness must be enjoyed but not clung to.',
    themes: ['harmony', 'renewal'], dimensions: { favorability: 2.0, certainty: 1.0, volatility: 0.5 }, modifierRoles: ['subject', 'effect'], binary: '101100' },
  { number: 56, name: 'The Wanderer',                symbol: '䷷', judgment: 'Travel and transition bring change. The stranger must act with care.',
    themes: ['mystery', 'transformation'], dimensions: { favorability: -0.5, certainty: -1.5, volatility: 1.5 }, modifierRoles: ['subject', 'action'], binary: '001101' },
  { number: 57, name: 'The Gentle',                  symbol: '䷸', judgment: 'Gentle penetration achieves great effects. The wind shapes the mountain.',
    themes: ['harmony', 'surrender'], dimensions: { favorability: 0.5, certainty: 0.5, volatility: -0.5 }, modifierRoles: ['action'], binary: '011011' },
  { number: 58, name: 'The Joyous',                  symbol: '䷹', judgment: 'Joy shared multiplies. Expression of happiness attracts good fortune.',
    themes: ['harmony', 'renewal'], dimensions: { favorability: 1.5, certainty: 0.5, volatility: 0.0 }, modifierRoles: ['subject', 'effect'], binary: '110110' },
  { number: 59, name: 'Dispersion',                  symbol: '䷺', judgment: 'Division dissolves through shared purpose. Gather the scattered.',
    themes: ['transformation', 'conflict'], dimensions: { favorability: -0.5, certainty: 0.0, volatility: 1.5 }, modifierRoles: ['action', 'effect'], binary: '010011' },
  { number: 60, name: 'Limitation',                  symbol: '䷻', judgment: 'Boundaries create form and meaning. Acceptance of limits brings success.',
    themes: ['authority', 'stagnation'], dimensions: { favorability: 0.0, certainty: 1.5, volatility: -1.5 }, modifierRoles: ['action'], binary: '110010' },
  { number: 61, name: 'Inner Truth',                 symbol: '䷼', judgment: 'Sincerity moves even the unreachable. Simple truth has great power.',
    themes: ['illumination', 'harmony'], dimensions: { favorability: 1.0, certainty: 0.5, volatility: -1.0 }, modifierRoles: ['subject', 'action'], binary: '110011' },
  { number: 62, name: 'Small Preponderance',         symbol: '䷽', judgment: 'Small actions have large consequences. Moderation in all things.',
    themes: ['stagnation', 'surrender'], dimensions: { favorability: -0.5, certainty: 0.0, volatility: 0.0 }, modifierRoles: ['action', 'effect'], binary: '001100' },
  { number: 63, name: 'After Completion',            symbol: '䷾', judgment: 'Order has been achieved. Vigilance prevents decline into disorder.',
    themes: ['harmony', 'transformation'], dimensions: { favorability: 1.0, certainty: 2.0, volatility: -1.5 }, modifierRoles: ['subject', 'effect'], binary: '101010' },
  { number: 64, name: 'Before Completion',           symbol: '䷿', judgment: 'The work is nearly done. Caution and care complete the task.',
    themes: ['mystery', 'transformation'], dimensions: { favorability: 0.0, certainty: -1.5, volatility: 1.5 }, modifierRoles: ['subject', 'action'], binary: '010101' },
];
